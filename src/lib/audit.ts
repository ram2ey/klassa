...
export const AuditActions = {
  ...
  GUARDIAN_INQUIRY_CREATED: "guardian_inquiry.created",
  GUARDIAN_INQUIRY_REPLIED: "guardian_inquiry.replied",
  GUARDIAN_INQUIRY_STATUS_UPDATED: "guardian_inquiry.status_updated",
  ...
  SEN_PROFILE_CREATED: "sen_profile.created",
  SEN_PROFILE_UPDATED: "sen_profile.updated",
  SEN_REVIEW_COMPLETED: "sen_review.completed",
