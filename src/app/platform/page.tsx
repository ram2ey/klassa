...
export default async function PlatformPage() {
  if (isDemoMode()) return <main className="mx-auto max-w-xl space-y-3 p-6"><h1 className="text-xl font-bold">Platform administration</h1>
    <p>Live school and staff provisioning is unavailable in the local demo. Connect PostgreSQL, disable demo mode and sign in with your platform administrator account.</p></main>;
